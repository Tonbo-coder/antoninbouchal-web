...
export interface CourseDetailNewProps {
  name: string;
...
export default function CourseDetailNew({
  ...
  const items = learnItems.slice(0, 6);

  return (
    <>
      {/* ── HERO ── */}
      <section ref={heroRef} className="relative pt-32 pb-0 md:pt-44 bg-[#f9fafb] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 xl:px-16 relative z-10">
          <div className="relative pb-20 md:pb-28">
            ...
            {/* Course icon sitting on the divider – same pattern as /skoleni */}
        ...
        {/* Divider inside section so icon sits precisely on it */}
      ...
      <section ref={formRef} id="objednavka" className="py-20 md:py-28 bg-[#f9fafb]">
        <div className="max-w-7xl mx-auto px-6 md:px-10 xl:px-16">
          <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] lg:grid-cols-[260px_1fr] gap-8 md:gap-10 lg:gap-20">
            ...
            <div className="reveal-left flex md:flex-col md:items-start items-center gap-2 md:pt-1">
              <span className="text-[11px] font-bold text-[var(--orange)] tracking-[0.2em] uppercase">04</span>
              <h2 className="text-[22px] font-bold uppercase tracking-[0.08em] text-[var(--text-dark)]">
                Mám zájem
              </h2>
              <div className="hidden md:block mt-3 w-10 h-[3px] bg-[var(--orange)] rounded-full" />
                ...
                <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="flex flex-col gap-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" required value={form.name} onChange={set("name")} placeholder="Jan Novák" className={inputCls} />
                    </div>
                    <div>
                      <label className="block text-[12px] font-bold uppercase tracking-[0.18em] text-gray-400 mb-2">E-mail *</label>
                      <input type="email" required value={form.email} onChange={set("email")} placeholder="jan@example.cz" className={inputCls} />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="tel" value={form.phone} onChange={set("phone")} placeholder="+420 123 456 789" className={inputCls} />
                    </div>
                    <div>
                      <label className="block text-[12px] font-bold uppercase tracking-[0.18em] text-gray-400 mb-2">Firma / organizace</label>
                      <input type="text" value={form.company} onChange={set("company")} placeholder="Název firmy (nepovinné)" className={inputCls} />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input type="text" value={form.participants} onChange={set("participants")} placeholder="1–10" className={inputCls} />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <input type="text" value={form.date} onChange={set("date")} placeholder="např. únor 2026, nebo dle dohody" className={inputCls} />
                  </div>
