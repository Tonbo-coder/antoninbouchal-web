...
export const metadata: Metadata = {
  ...
  description:
    "Naučíte se využívat AI v praxi. Automatizace, generování textu a efektivní workflow, které vám ušetří hodiny práce.",
  keywords: [
    "ai školení",
    "umělá inteligence kurz",
    "chatgpt školení",
    "ai produktivita",
    "ai automatizace",
    "Antonín Bouchal",
  ...
  alternates: {
    canonical: "https://www.antoninbouchal.cz/skoleni/ai-prace",
  },
  openGraph: {
    title: "AI, která vám ušetří hodiny práce | Školení umělé inteligence",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AI, která vám ušetří hodiny práce – Antonín Bouchal",
      },
    ],
  },
  twitter: {
