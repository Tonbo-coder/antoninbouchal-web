...
export const metadata: Metadata = {
  ...
  description: "Ovládnete Word na pokročilé úrovni. Styly, automatické obsahy, číslování a profesionální formátování bez chaosu.",
  keywords: ["word pokročilý", "styly word", "automatický obsah word", "formátování dokumentů", "školení word", "Antonín Bouchal"],
  authors: [{ name: "Antonín Bouchal" }],
  alternates: { canonical: "https://www.antoninbouchal.cz/skoleni/docxmaster" },
  openGraph: {
    title: "Word na úrovni, kterou jinde neučí | Školení MS Word pro pokročilé",
    description: "Pokročilé školení Wordu zaměřené na styly, číslování, automatický obsah a profesionální formátování.",
    type: "website", url: "https://www.antoninbouchal.cz/skoleni/docxmaster",
    siteName: "Antonín Bouchal", locale: "cs_CZ",
    images: [{ url: "/images/antonin-bouchal-skoleni.webp", width: 1200, height: 630, alt: "DOCXmaster – Antonín Bouchal" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Word na úrovni, kterou jinde neučí | Školení MS Word pro pokročilé",
    description: "Pokročilé školení Wordu pro profesionální dokumenty.",
    images: { url: "/images/antonin-bouchal-skoleni.webp", alt: "DOCXmaster – Antonín Bouchal" },
  },
};
